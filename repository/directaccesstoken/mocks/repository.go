...
func (m *MockRepository) FetchList(ctx context.Context, filter *directaccesstoken.Filter, order *directaccesstoken.ListOrder, page *directaccesstoken.Pagination) ([]*directaccesstoken.DirectAccessToken, error) {
	m.ctrl.T.Helper()
...
func (mr *MockRepositoryMockRecorder) FetchList(ctx, filter, order, page any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRepositoryMockRecorder) Revoke(ctx, filter any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
