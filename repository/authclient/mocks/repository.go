...
func (m *MockRepository) Count(ctx context.Context, opts ...authclient.QOption) (int64, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx}
	for _, a := range opts {
...
func (m *MockRepository) FetchList(ctx context.Context, opts ...authclient.QOption) ([]*authclient.AuthClient, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx}
	for _, a := range opts {
		varargs = append(varargs, a)
...
func (m *MockRepository) Get(ctx context.Context, id string) (*authclient.AuthClient, error) {
	m.ctrl.T.Helper()
