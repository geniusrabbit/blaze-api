...
type AuthClientConnection = connectors.CollectionConnection[gqlmodels.AuthClient, gqlmodels.AuthClientEdge]
...
func NewAuthClientConnection(ctx context.Context, authClientsAccessor authclient.Usecase, page *gqlmodels.Page) *AuthClientConnection {
	return connectors.NewCollectionConnection(ctx, &connectors.DataAccessorFunc[gqlmodels.AuthClient, gqlmodels.AuthClientEdge]{
