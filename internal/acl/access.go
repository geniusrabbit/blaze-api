...
func HaveObjectPermissions(ctx context.Context, obj interface{}, permissions ...string) bool {
...
func HaveAccessView(ctx context.Context, obj interface{}) bool {
...
func HaveAccessList(ctx context.Context, obj interface{}) bool {
...
func HaveAccessCreate(ctx context.Context, obj interface{}) bool {
...
func HaveAccessUpdate(ctx context.Context, obj interface{}) bool {
...
func HaveAccessDelete(ctx context.Context, obj interface{}) bool {
	return session.Account(ctx).CheckPermissions(ctx, obj, PermDelete)
}

// HaveAccountLink of the object to the current account
func HaveAccountLink(ctx context.Context, obj interface{}) bool {
